...
export const createController = async (c: Context) => {
  ...
  const result = await countryService.createOne(body);
...
export const createManyController = async (c: Context) => {
  ...
  const result = await countryService.createMany(body);
...
export const updateController = async (c: Context) => {
  ...
  const updatedResult = await countryService.updateOne(params.id, body);
...
export const deleteController = async (c: Context) => {
  ...
  const deletedResult = await countryService.deleteOne(params.id);
...
export const getController = async (c: Context) => {
  ...
  const result = await countryService.getOne(params.id);
...
export const getAllController = async (c: Context) => {
  ...
  const result = await countryService.getAll(query);
...
export const deleteManyController = async (c: Context) => {
  ...
  const result = await countryService.deleteMany(body.ids);
...
export const exportCsvController = async (c: Context) => {
  const csvData = await countryService.exportCsv();
  c.header('Content-Type', 'text/csv; charset=utf-8');
  c.header('Content-Disposition', 'attachment; filename="country.csv"');
