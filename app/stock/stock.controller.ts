...
export const createController = async (c: Context) => {
  ...
  const result = await stockService.createOne(body);
...
export const createManyController = async (c: Context) => {
  ...
  const result = await stockService.createMany(body);
  return c.json({
    success: true,
    data: result,
...
export const updateController = async (c: Context) => {
  ...
  const result = await stockService.updateOne(params.id, body);
