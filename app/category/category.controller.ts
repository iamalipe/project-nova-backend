...
export const createController = async (c: Context) => {
  ...
  const result = await categoryService.createOne(body);
...
export const createManyController = async (c: Context) => {
  ...
  const result = await categoryService.createMany(body);
...
export const updateController = async (c: Context) => {
  ...
  const updatedResult = await categoryService.updateOne(params.id, body);
...
export const deleteController = async (c: Context) => {
  ...
  const deletedResult = await categoryService.deleteOne(params.id);
...
export const getController = async (c: Context) => {
  ...
  const result = await categoryService.getOne(params.id);
