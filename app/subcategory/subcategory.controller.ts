...
export const createController = async (c: Context) => {
  ...
  const result = await subcategoryService.createOne(body);
...
export const createManyController = async (c: Context) => {
  ...
  const result = await subcategoryService.createMany(body);
...
export const updateController = async (c: Context) => {
  ...
  const updatedResult = await subcategoryService.updateOne(params.id, body);
...
export const deleteController = async (c: Context) => {
  ...
  const deletedResult = await subcategoryService.deleteOne(params.id);
...
export const getController = async (c: Context) => {
  ...
  const result = await subcategoryService.getOne(params.id);
...
export const deleteManyController = async (c: Context) => {
  ...
  const result = await subcategoryService.deleteMany(body.ids);
...
export const exportCsvController = async (c: Context) => {
  const csvData = await subcategoryService.exportCsv();
  c.header('Content-Type', 'text/csv; charset=utf-8');
  c.header('Content-Disposition', 'attachment; filename="subcategory.csv"');
