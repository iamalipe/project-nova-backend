...
export const createSchema = z.object({
  body: z.object({
    ...
    warehouseCode: z.string().length(6, 'Warehouse code must be exactly 6 characters'),
    addressLine1: z.string().min(1),
    zip: z.string().min(1),
    stateId: z.string().uuid(),
    countryId: z.string().uuid(),
    mapLocation: z.string().url().optional().nullable().or(z.literal('')),
...
export const createManySchema = z.object({
  body: z.array(
    z.object({
      name: z.string().min(1).max(255),
      warehouseCode: z.string().length(6),
      addressLine1: z.string().min(1),
      zip: z.string().min(1),
      stateId: z.string().uuid(),
      countryId: z.string().uuid(),
...
export const updateSchema = z.object({
  ...
  body: z.object({
    ...
    warehouseCode: z.string().length(6).optional(),
    ...
    description: z.string().optional().nullable(),
    supplyStoreIds: z.array(z.string().uuid()).optional(),
